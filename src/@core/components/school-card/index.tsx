    ...
    return (
        <div className="mx-xl-4 mx-lg-2 mx-md-2 mx-5 card hover-card featuredClgCard mb-4">
            <div className='card-image'>
                <Image src={`${process.env.NEXT_PUBLIC_IMG_URL}/${college.banner_image}`} width={500} height={500} className="card-Image-top" alt="featured-college" />
            </div>
...
export default SchoolCard; // Make sure to export the component
