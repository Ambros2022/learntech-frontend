        ...
        <div className="container text-white pt-3">
          <div className="row">
            ...
            <div className="col-md-6 text-md-end order-1 order-md-2 text-center">
              ...
              <a href="https://www.facebook.com/learntechedu" target='_blank'><Image width={27} height={27} style={{ height: 'auto' }} className='icon-white mx-2' src="/images/icons/Facebook.svg" alt="facebook-icon" /></a>
              <a href="https://www.linkedin.com/company/learntech-edu-solutions-pvt-ltd/" target='_blank'><Image width={27} height={27} style={{ height: 'auto' }} className='icon-white me-2' src="/images/icons/linked-in.svg" alt="linkedIn-icon" /></a>
              <a href="https://twitter.com/learntechww" target='_blank'><Image width={27} height={27} style={{ height: 'auto' }} className='icon-white me-2' src="/images/icons/twitter-x.png" alt="twitter-icon" /></a>
              <a href="https://www.instagram.com/learntechedus" target='_blank'><Image width={27} height={27} style={{ height: 'auto' }} className='icon-white me-2' src="/images/icons/instagram.svg" alt="instagram-icon" /></a>
              <a href="https://www.youtube.com/channel/UCZP40_ivVcdelNOVhmQFr7w" target='_blank'><Image width={27} height={27} style={{ height: 'auto' }} className='icon-white me-2' src="/images/icons/youtube.svg" alt="youtube-icon" /></a>
            </div>
          </div>
        </div>
        <Toster />
