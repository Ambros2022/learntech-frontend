...
import AddEditForm from 'src/views/app/dashboard/scholarship/AddEditForm'
...
const Edituserlayout = () => {
  ...
  const getolddata = useCallback(async () => {
    try {
      ...
      const response = await axios1.get('api/admin/scholarship/get/' + id);
    ...
    <>
        ...
        <Card>
          ...
          >
            ...
            <Link href={`../`} >
              <Button variant='contained'>View All scholarship</Button>
            </Link>
          </Box>
          <CardContent>
