...
import AddEditForm from 'src/views/app/dashboard/blogcategories/AddEditForm'
...
const Edituserlayout = () => {
  ...
  const getolddata = useCallback(async () => {
    try {
      ...
      const response = await axios1.get('api/admin/blogscategories/get/' + id);
