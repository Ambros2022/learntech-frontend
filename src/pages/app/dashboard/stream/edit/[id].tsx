...
import AddEditForm from 'src/views/app/dashboard/stream/AddEditForm'
...
const Edituserlayout = () => {
  ...
  const getolddata = useCallback(async () => {
    try {
      ...
      const response = await axios1.get('api/admin/stream/get/' + id);
    ...
    <>
        ...
        <Card>
          ...
          >
            ...
            <Link href={`../`} >
              <Button variant='contained'>View All Stream</Button>
            </Link>
          </Box>
          <CardContent>
