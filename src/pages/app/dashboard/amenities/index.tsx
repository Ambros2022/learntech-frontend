...
const SecondPage = () => {
  ...
  const [searchfrom, setSearchfrom] = useState<any>('amenities_name')
  const [columnname, setColumnname] = useState<string>('amenities_name')
