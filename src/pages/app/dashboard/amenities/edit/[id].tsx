...
import AddEditForm from 'src/views/app/dashboard/amenities/AddEditForm'
...
const Edituserlayout = () => {
  ...
  const getolddata = useCallback(async () => {
    try {
      ...
      const response = await axios1.get('api/admin/amenities/get/' + id);
    ...
    <>
        ...
        <Card>
          ...
          >
            ...
            <Link href={`../`} >
              <Button variant='contained'>View All Amenities</Button>
            </Link>
          </Box>
          <CardContent>
