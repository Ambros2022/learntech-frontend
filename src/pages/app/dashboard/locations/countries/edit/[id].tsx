...
// // import AddEditForm from 'src/views/class/AddEditForm'
...
//       const response = await axios1.get('/api/admin/class/' + id);
...
//   return (
//     <>
//       {ability?.can('update', 'all-classes') ? (
//         <Card>
//           <Box
//             sx={{
//               gap: 2,
...
//             <Link href={`/class`} >
//               <Button variant='contained'>View All Classes</Button>
//             </Link>
//           </Box>
//           <CardContent>
