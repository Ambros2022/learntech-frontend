...
import AddEditForm from 'src/views/app/dashboard/Pagess/AddEditForm'
...
const Edituserlayout = () => {
  ...
  const getolddata = useCallback(async () => {
    try {
      ...
      const response = await axios1.get('api/admin/page/get/' + id);
    ...
    <>
        ...
        <Card>
          ...
          >
            ...
            <Link href={`../`} >
              <Button variant='contained'>View All pages</Button>
            </Link>
          </Box>
          <CardContent>
