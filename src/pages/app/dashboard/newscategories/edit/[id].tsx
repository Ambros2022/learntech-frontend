...
import AddEditForm from 'src/views/app/dashboard/newscategories/AddEditForm'
...
const Edituserlayout = () => {
  ...
  const getolddata = useCallback(async () => {
    try {
      ...
      const response = await axios1.get('api/admin/newscategories/get/' + id);
    ...
    <>
        ...
        <Card>
          ...
          >
            ...
            <Link href={`../`} >
              <Button variant='contained'>View All newscategories</Button>
            </Link>
          </Box>
          <CardContent>
