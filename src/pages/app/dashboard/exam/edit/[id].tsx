...
// import AddEditForm from 'src/views/app/dashboard/exam/AddEditForm'
...
const AddEditForm = dynamic(() => import('src/views/app/dashboard/exam/AddEditForm'))
...
const Edituserlayout = () => {
  ...
  const getolddata = useCallback(async () => {
    try {
      ...
      const response = await axios1.get('api/admin/exam/get/' + id);
