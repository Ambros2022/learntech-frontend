      ...
      <section className='bg-white faqSec'>
        <div className="row">
          <div className="col-md-6 faqImgSec container d-flex justify-content-center">
            <Image src="/images/icons/faq-img.png" className='align-content-center' width={500} height={500} alt='faq-img' />
          </div>
          <div className="col-md-6 bg-blue py-5">
            <h2 className='text-white fw-bold ps-5'>FAQs</h2>
