    ...
    <section className='bg-blue collegeDetailBanner py-1 clsheight'>
      <div className="container-fluid">
        <div className="card w-100 mb-3 collegeDetailCard">
            ...
            <div className="col-lg-7 ps-xl-5 col-xl-8 col-md-10">
              <div className="card-body text-white">
                ...
                <h6 className='mb-3 location-img'>
                  <i className='bi bi-mortarboard-fill text-warning me-2' />
                  <strong>Board: </strong>
                  {data?.boardschools?.map((v: any) => v?.schbordname?.short_name).join(', ')}
                </h6>
                <h6 className='mb-3 location-img d-flex'>
                  ...
                  {data?.schoollevels?.map((v: any) => v?.schlevelname?.name).join(', ')}
                </h6>
              </div>
            </div>
          ...
          <div className="d-flex justify-content-center justify-content-md-end flex-md-row flex-wrap gap-1 gap-md-3">
