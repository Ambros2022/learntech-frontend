        ...
        <div className="container">
          ...
          <div className="row px-3">
            <div className="col-md-6 d-flex justify-content-start locatedSec px-md-5 g-0">
              <div className="w-100 align-self-start card mb-3 bg-lightCard p-3">
                <div className="row g-0">
                  ...
                  <div className="col-lg-12 d-flex">
                    <div className="card-body align-content-start text-white p-0 mt-2 text-center text-lg-start">
