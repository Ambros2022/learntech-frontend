        ...
        <>
            ...
            <section className='bg-white'>
                <div className='container py-2'>
                    <Link href='/' className='text-black'>Home</Link> {'>'} <Link href="/news" className='text-black'>News</Link> {'>'} <Link href="/news" className='text-blue'> Karnataka 2nd PUC Results Announced</Link>
                </div>
            </section>
        </>
