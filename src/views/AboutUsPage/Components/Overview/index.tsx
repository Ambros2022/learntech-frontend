...
const Overview = () => {
  const [activeTab, setActiveTab] = useState('v-pills-who-we-are')

  const tabs = [
    { id: 'v-pills-who-we-are', label: 'Who We Are' },
    { id: 'v-pills-our-mission', label: 'Our Mission' },
    { id: 'v-pills-our-vision', label: 'Our Vision' },
    { id: 'v-pills-what-do-we-offer', label: 'What Do We Offer?' },
    { id: 'v-pills-why-choose-us', label: 'Why Choose Us?' },
  ]
        ...
        <div className="row">
          <div className={`col-md-4 col-xl-2 col-lg-3 d-flex flex-column ${styles.aboutUsSec}`}>
            <div className="d-flex align-items-start">
              <div
                className="nav flex-column gap-3 nav-pills me-3"
                id="v-pills-tab"
                role="tablist"
          ...
          <div className="col-md-8 col-xl-10 col-lg-9">
            <div className="tab-content mt-md-0 mt-3 text-black" id="v-pills-tabContent">
              <div
                className={`tab-pane fade ${activeTab === 'v-pills-who-we-are' ? 'show active' : ''}`}
                id="v-pills-who-we-are"
                role="tabpanel"
              ...
              >
                ...
                <p className="text-black">
                  Through tailored marketing strategies and leveraging our extensive network, Learntech empowers educational institutions to strengthen their brand, expand their reach, and secure a competitive edge in the ever-evolving education sector. Our commitment is to foster mutually beneficial relationships, driving growth and success for both students and academic institutions a like.
                </p>
              </div>

              <div
                className={`tab-pane fade ${activeTab === 'v-pills-our-mission' ? 'show active' : ''}`}
                id="v-pills-our-mission"
                role="tabpanel"
              ...
              <div
                className={`tab-pane fade ${activeTab === 'v-pills-our-vision' ? 'show active' : ''}`}
                id="v-pills-our-vision"
                role="tabpanel"
                aria-labelledby="v-pills-our-vision-tab"
              >
                <p className="text-black">
                  Learntech Edu Solutions has a vision to become the global leader in providing educational services and be recognized for their unwavering commitment to helping students achieve their academic and career goals. We aim to create a future where every student, regardless of their background, has access to the best educational opportunities tailored to their individual interests and strengths. By building strong, collaborative relationships with colleges and universities, we envision becoming the preferred partner for institutions seeking to expand their reach, enhance their brand, and attract qualified students. Our goal is to set a new standard in educational services, where our expertise, innovation, and dedication help shape the educational sector, making quality education accessible and attainable for all.
                </p>
              </div>

              <div
                className={`tab-pane fade ${activeTab === 'v-pills-what-do-we-offer' ? 'show active' : ''}`}
                id="v-pills-what-do-we-offer"
                role="tabpanel"
                aria-labelledby="v-pills-what-do-we-offer-tab"
              >
                <p className="text-black">
                ...
                <h2 className="fw-bold text-black f20">For Students:</h2>
                  ...
                  <tbody className="text-center">
                    <tr>
                      <td className="d-block d-md-table-cell">
                        <div className="col">
                          <Image
                            src="/images/aboutus/Career_Counselling.png"
                            width={50}
                            height={50}
                      ...
                      <td className="d-block d-md-table-cell">
                        <div className="col">
                          <Image
                            src="/images/aboutus/Mentoring_for_Entrance_Exams.png"
                            width={50}
                            height={50}
                            alt="Mentoring for Entrance Exams"
                            loading="lazy"
                          />
                      ...
                      <td className="d-block d-md-table-cell">
                        <div className="col">
                          <Image
                            src="/images/aboutus/Assistance.png"
                            width={50}
                            height={50}
                            alt="Assistance for Educational Loans and Scholarships"
                            loading="lazy"
                          />
                      ...
                      <td className="d-block d-md-table-cell">
                        <div className="col">
                          <Image
                            src="/images/aboutus/Seat_Reservation_Facilities.png"
                            width={50}
                            height={50}
                            alt="Seat Reservation Facilities"
                            loading="lazy"
                          />
                      ...
                      <td className="d-block d-md-table-cell">
                        <div className="col">
                          <Image
                            src="/images/aboutus/facilitate.png"
                            width={50}
                            height={50}
                            alt="Facilitate Direct Meetings with Colleges and Universities"
                            loading="lazy"
                          />
                      ...
                      <td className="d-block d-md-table-cell">
                        <div className="col">
                          <Image
                            src="/images/aboutus/nri.png"
                            width={50}
                            height={50}
                            alt="NRI Admission Assistance"
                            loading="lazy"
                          />
                      ...
                      <td className="d-block d-md-table-cell">
                        <div className="col">
                          <Image
                            src="/images/aboutus/assistance_to_Pay.png"
                            width={50}
                            height={50}
                            alt="Assistance to Pay Fees via EMI"
                            loading="lazy"
                          />
                ...
                <h2 className="fw-bold text-black f20 pt-3">For Colleges and Universities:</h2>
                    ...
                    <tbody className="text-center">
                      <tr>
                        <td className="d-block d-md-table-cell">
                          <div>
                            <Image
                              src="/images/aboutus/Branding.png"
                              width={50}
                              height={50}
                        ...
                        <td className="d-block d-md-table-cell">
                          <div>
                            <Image
                              src="/images/aboutus/Lead_Generation.png"
                              width={50}
                              height={50}
                              alt="Lead Generation for Admissions"
                              loading="lazy"
                            />
                        ...
                        <td className="d-block d-md-table-cell">
                          <div>
                            <Image
                              src="/images/aboutus/Collaborative.png"
                              width={50}
                              height={50}
                              alt="Collaborative Promotional Events"
                              loading="lazy"
                            />
                        ...
                        <td className="d-block d-md-table-cell">
                          <div>
                            <Image
                              src="/images/aboutus/Social_Media.png"
                              width={50}
                              height={50}
                        ...
                        <td className="d-block d-md-table-cell">
                          <div>
                            <Image
                              src="/images/aboutus/Digital_Marketing.png"
                              width={50}
                              height={50}
