      ...
      <div className="container">
        <div className="w-100 card mb-3 collegeDetailCard text-md-start">
              ...
              <div className="py-md-3 py-2 text-white">
                ...
                <div className="d-flex flex-column flex-md-row align-items-md-center gap-md-5">
                  <div className="mb-3 d-flex align-items-center">
                    <i className="bi bi-alarm-fill text-warning bi-icon me-2" />
                    <span className="fw-bold text-start" style={{ fontSize: '16px' }}>
                      Last Date of Application:{' '}
                      <span className='fw-normal text-white'>{formatDate(data.last_date)}</span>
                    </span>
                  </div>
                  <div className="mb-3 d-flex align-items-center">
                    <i className="bi bi-currency-rupee bi-icon text-danger me-2" />
          ...
          <div className="text-md-end text-center mt-md-3 mt-0">
            <GlobalEnquiryForm buttonText=" Apply Now for Scholarship" className="btn btn-success" />
          </div>
        </div>
      </div>
    </section>
