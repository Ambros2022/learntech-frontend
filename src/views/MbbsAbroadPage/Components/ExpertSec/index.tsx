    ...
    return (
        <>
            <section className='bg-white pt-3 pb-5'>
                <div className="container bg-white text-center p-5" style={{ backgroundImage: 'linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url("/images/icons/mbbsAbroad.jpg")', backgroundPosition: "center center", backgroundRepeat: "no-repeat" }}>
                    <h2 className='text-white fw-bold mb-3 rounded'>Are You Eligible for MBBS Abroad?</h2>
                    <h6 className='text-blue rounded p-2 mb-3' style={{ display: 'inline-block', backgroundColor: 'white' }}>
