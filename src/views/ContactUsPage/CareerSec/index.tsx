...
import { LazyContactPageUsForm } from 'src/app/components/ClientWrappers'
            ...
            <div className='bg-blue p-md-4 p-3 h-100 rounded'>
              ...
              <div className="d-flex mb-3">
                <div className='align-self-center'>
                  <img src='/images/icons/phoneAbout1R.png' width={30} height={30} alt='phone icon' className='img-fluid' />
                </div>
                <div>
              ...
              <div className="d-flex mb-3">
                <div className=''>
                  <img src='/images/icons/phoneAbout2.png' className='img-fluid' width={30} height={30} alt='office phone icon' />
                </div>
                <div className='align-self-center'>
              ...
              <div className="d-flex mb-3">
                <div className='faxicon'>
                  <img src='/images/icons/fax2.svg' className='img-fluid' width={30} height={30} alt='fax icon' />
                </div>
                <div className='align-self-center'>
              ...
              <div className="d-flex mb-3">
                <div className=''>
                  <img src='/images/icons/email-icon.svg' width={30} height={30} alt='email icon' className='img-fluid icon-white' />
                </div>
                <div className='align-self-center'>
