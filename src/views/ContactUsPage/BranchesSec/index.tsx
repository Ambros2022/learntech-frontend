    ...
    const branchData = [
        {
            ...
            address: '#80 (4), E End D Main Rd, Phase 3 Tilak Nagar, Jayanagara 9th Block, Bengaluru, Karnataka 560041',
            phone: '+91-9036020005 / 16',
        ...
        {
            name: 'Dubai',
            address: '6, First Floor, Al Mamzar Centre Al Qiyadah Metro Station, Dubai',
        ...
        {
            name: 'Bahrain',
            address: 'Shop 240-Y, Road No: 5607, Block No: 756, Aali, Manama, Bahrain',
    ...
    return (
        <section className='bg-white branchLink pb-5'>
            <div className="container">
                <h4 className='text-center fw-bold text-blue mb-3'>FIND US @</h4>
                            ...
                            >
                                <div className="row">
                                    ...
                                    <div className="col-md-12 text-md-center text-lg-start mt-md-2 col-xl-10 col-lg-10">
                                        ...
                                        <h5 className='text-black fw-bold ms-lg-2'>{branch.name} Office</h5>
                                    </div>
                                </div>
                                <div className="row pt-3">
                                    <div className="col-lg-10 ms-auto">
                                        <h6 className='ms-lg-2'>
                                            ...
                                            <Link target='_blank' href={branch.addressUrl || '#'}>
                                                {branch.address}
                                            </Link>
                                        </h6>
                                        <h6 className='ms-lg-2'>
