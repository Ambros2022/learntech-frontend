            ...
            <div className="container bg-skyBlue rounded p-5">
                ...
                <div className='pt-3 d-flex justify-content-center gap-3 flex-wrap'>
                    <div className='rounded' style={{ width: '220px', height: '100%' }}>
                        ...
                        <h5 className='fw-bold text-black my-3 text-center'>Fill out the Student Loan Application Form</h5>
                    </div>
                    ...
                    <div className='rounded' style={{ width: '220px', height: '100%' }}>
                        ...
                        <h5 className='fw-bold text-black my-3 text-center'>Submit the Required Documents   </h5>
                    </div>
                    <span className='align-self-center'>
                        <i className='bi fw-bold fs-5 bi-arrow-right arrow-right text-black'></i>
                        <i className='bi fw-bold fs-5 bi-arrow-down arrow-down text-black'></i>
                    ...
                    <div className='rounded' style={{ width: '220px', height: '100%' }}>
                        ...
                        <h5 className='fw-bold text-black my-3 text-center'>Application Review by the Bank</h5>
                    </div>
                    <span className='align-self-center'>
                        <i className='bi fw-bold fs-5 bi-arrow-right arrow-right text-black'></i>
                        <i className='bi fw-bold fs-5 bi-arrow-down arrow-down text-black'></i>
                    ...
                    <div className='rounded' style={{ width: '220px', height: '100%' }}>
                        ...
                        <h5 className='fw-bold text-black my-3 text-center'>Pay the Loan to your Educational Institute</h5>
                    </div>
                </div>
            </div>
        </section>
