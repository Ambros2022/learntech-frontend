            ...
            <div className="container">
                ...
                <div className="row bg-white d-flex">
                    <div className="col-md-4">
                        <div className="card border-0 p-3 rounded">
                            <h4 className='text-center mb-3 fw-bold'>
                                <Image src='/images/icons/sapphire.svg' width={50} height={50} className='me-2 img-fluid' alt='sapphire-img' />
                                Sapphire package
                            </h4>
                            ...
                            <div className="text-center">
                                <button className='btn viewMoreCollegeBtn px-4 py-2' onClick={handleScrollToBanner}>Buy Now</button>
                            </div>
                        </div>
                    </div>
                    <div className="col-md-4">
                        <div className="card border-0 p-3 rounded">
                            <h4 className='text-center mb-3 fw-bold'>
                                <Image src='/images/icons/diamond.svg' width={50} height={50} className='me-2 img-fluid' alt='diamond-img' />
                                Diamond package
                            </h4>
                    ...
                    <div className="col-md-4">
                        <div className="card border-0 p-3 rounded">
                            <h4 className='text-center mb-3 fw-bold'>
                                <Image src='/images/icons/luggage.svg' width={50} height={50} className='me-2 img-fluid' alt='luggage-img' />
                                Diamond package <br />
                                <span className='fs-5 ms-3'>(For NRI Students)</span>
                            </h4>
                    ...
                    <div className="text-center mb-3">
                        <button onClick={handleScrollToExam} className='btn viewMoreCollegeBtn py-3 px-5'>Services Offered at GCC Countries</button>
                    </div>
                </div>
            </div>
        </section>
