    ...
    return (
        <>
                            ...
                            <div className='d-flex'>
                                ...
                                <div className="d-flex flex-column gap-3">
                                    <Link className='d-flex' href='tel:+91 90058 00200'>
                                        <Image src='/images/icons/whatsapp.png' width={20} height={20} alt='whatsapp-logo' className="me-1" /><h6 className='m-0 text-white align-self-center'>+91 90058 00200</h6>
                                    </Link>
                                    <Link className='d-flex' href='tel:+91 90057 00300'>
                                        <Image src='/images/icons/whatsapp.png' width={20} height={20} alt='whatsapp-logo' className="me-1" /><h6 className='m-0 text-white align-self-center'>+91 90057 00300</h6>
                                    </Link>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className='d-flex'>
                                ...
                                <div className="d-flex flex-column gap-3">
                                    <Link className='d-flex' href='tel:+971 50 2436552'>
                                        <Image src='/images/icons/whatsapp.png' width={20} height={20} alt='whatsapp-logo' className="me-1" /><h6 className='m-0 text-white align-self-center'>+971 50 2436552</h6>
                                    </Link>
                                    <Link className='d-flex' href='tel:+971 50 4955123'>
                                        <Image src='/images/icons/whatsapp.png' width={20} height={20} alt='whatsapp-logo' className="me-1" /><h6 className='m-0 text-white align-self-center'>+971 50 4955123</h6>
                                    </Link>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className='d-flex'>
                                ...
                                <div className="d-flex flex-column gap-3">
                                    <Link className='d-flex' href='tel:+973 35 480190'>
                                        <Image src='/images/icons/whatsapp.png' width={20} height={20} alt='whatsapp-logo' className="me-1" /><h6 className='m-0 text-white align-self-center'>+973 35 480190</h6>
                                    </Link>
                                    <Link className='d-flex' href='tel:+973 38 780368'>
                                        <Image src='/images/icons/whatsapp.png' width={20} height={20} alt='whatsapp-logo' className="me-1" /><h6 className='m-0 text-white align-self-center'>+973 38 780368</h6>
                                    </Link>
                                </div>
                            </div>
                        </div>
            ...
            <section className='bg-blue py-5'>
                <hr className='text-white' />
                <h4 className='text-center text-white mb-3 mt-5'>Copyright @ 2026</h4>
