...
const HelpSec = () => {
    return (
        <section className='helpSec position-relative'>
            <Image src='/images/icons/helpBanner.webp' className='bannerHelp' alt='help-banner' width={1400} height={500} style={{ objectFit: 'cover' }} />
                    ...
                    <div className="row">
                        <div className="col-lg-6 col-sm-6 mb-5">
                            <div className="card card-hover-effect p-3 border-white bg-transparent ">
                                ...
                                <h5 className='text-white fw-bold text-center mt-2'>Team of Experts:</h5>
                                <h6 className='text-white mb-0 text-center'>We have a dedicated team of experts who are determined to help you walk down the path.</h6>
                            </div>
                        </div>
                        <div className="col-lg-6 col-sm-6 mb-5">
                            <div className="card card-hover-effect p-3 border-white bg-transparent ">
                                <Image src='/images/icons/feedback.svg' className='mx-auto' alt='help-banner' width={150} height={150} />
                                <h5 className='text-white fw-bold text-center mt-2'>Insider Knowledge:</h5>
                                <h6 className='text-white mb-0 text-center'>Top Colleges, Pre and Post-Exam Process, Opportunities Abroad- We know it all!</h6>
                            </div>
                        </div>
                        <div className="col-lg-6 col-sm-6 mb-5">
                            <div className="card card-hover-effect p-3 border-white bg-transparent ">
                                <Image src='/images/icons/idea.svg' className='mx-auto' alt='help-banner' width={150} height={150} />
                                <h5 className='text-white fw-bold text-center mt-2'>Latest Developments:</h5>
                        ...
                        <div className="col-lg-6 col-sm-6 mb-5">
                            <div className="card card-hover-effect p-3 border-white bg-transparent ">
                                <Image src='/images/icons/pathway.svg' className='mx-auto' alt='help-banner' width={150} height={150} />
                                <h5 className='text-white fw-bold text-center mt-2'>Guidance for Every Course:</h5>
