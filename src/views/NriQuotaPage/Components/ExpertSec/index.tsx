    ...
    return (
        <>
            <section className='bg-white pt-3 pb-5'>
                <div className="container bg-white text-center p-5" style={{ backgroundImage: 'linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url("/images/icons/nriQuota.jpg")', backgroundPosition: "center center", backgroundRepeat: "no-repeat" }}>
