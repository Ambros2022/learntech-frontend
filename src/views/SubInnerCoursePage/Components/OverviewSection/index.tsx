      ...
      <section className='clgInfoSec bg-white'>
        <div className="container">
          ...
          <div className="row">
            <div className="col-lg-9">
              <div className="tab-content" id="nav-tabContent">
                <div className="tab-pane fade show active" id="nav-Overview" role="tabpanel" aria-labelledby="nav-Overview-tab">
                  <div className="row">
                    <div className="col-md-8 col-lg-12 text-black mb-5 pe-5">
            ...
            <div className="col-md-6 col-lg-3 mb-md-5 mx-auto px-0">
              <div className="row imgCardConCrs mb-3">
                ...
                <div className="col-12 cardConBrdr p-3 mb-3 overflow-y-scroll" style={{ height: '460px' }}>
                ...
                <div className="col-12 cardConBrdr p-3 overflow-y-scroll" style={{ height: '460px' }}>
