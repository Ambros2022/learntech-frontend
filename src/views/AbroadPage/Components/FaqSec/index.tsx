...
export default function FaqSec({ data }: { data: any }) {
  if (!data?.abroadpagefaqs?.length) return null
      ...
      <div className="container">
        ...
        <div className="row faqImgCon">
          ...
          <div className="col-md-6 mb-3 rounded">
            <div className="accordion" id="accordionAbroadFaq">
              {data.abroadpagefaqs.map((item: any, index: number) => (
