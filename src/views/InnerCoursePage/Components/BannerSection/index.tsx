      ...
      <div className="container h-100 flex-column column-gap-0 d-flex justify-content-center">
        <div className="align-items-center">
          <div className="row d-flex">
            <div className="align-content-center col-md-2 p-2 col-lg-1 col-auto mx-md-0 mb-md-0 mb-3 mx-auto bg-white rounded d-flex justify-content-center">
              <div className="align-content-center">
                <Image src={`${IMG_URL}/${data.logo}`} width={100} height={100} alt={data.name} />
              </div>
            </div>
              ...
              <div className="align-content-center row ps-lg-3 ps-md-2">
                <div className="col-12">
                  <h1 className='text-white text-md-start text-center'>
                    {data.name} Courses: Eligibility, Syllabus, Colleges, Admission
                  </h1>
                </div>
              </div>
