                    ...
                    <div className="d-flex justify-content-center">
                        <div className="text-center align-content-center">
                            ...
                            <div className='d-flex gap-3 justify-content-center flex-md-row flex-column mx-5 mx-md-0 flex-wrap socialThnks'>
                                ...
                                <Link className="text-blue btn viewDetailBtn" href="https://www.instagram.com/learntechedus" target='_blank'><img width={27} height={27} className='mx-2 p-1 rounded' src="/images/icons/InstagramForm.webp" alt="instagram-icon" />Instagram </Link>
