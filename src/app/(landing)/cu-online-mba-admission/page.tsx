import 'public/css/cumbalandingpage.css'
import CumbaPage from 'src/views/CumbaPage'
import JsonLd from 'src/app/components/JsonLd'

export const metadata = {
  title: 'CU Online MBA Admission 2026–27 | Chandigarh University',
  description: 'Apply for Chandigarh University (CU) Online MBA 2026–27. Check eligibility, fees, specializations, rankings, placements & admission process. Enquire Now!',
  alternates: {
